...
@implementation AllGroupsDataSource
...
- (SGridCell *)shinobiGrid:(ShinobiGrid *)grid cellForGridCoord:(const SGridCoord *) gridCoord
{
    if (gridCoord.rowIndex == 0)
    {
        ...
        [titleButton setTitle:@"Group" forState:UIControlStateNormal];
    ...
    else
    {
        ...
        cell.textField.text = [groupArray objectAtIndex:gridCoord.rowIndex - 1];
...
{
    NSMutableArray *newResult = [NSMutableArray arrayWithArray:groupArray];
