...
- (SGridCell *)shinobiGrid:(ShinobiGrid *)grid cellForGridCoord:(const SGridCoord *) gridCoord
{
    if (gridCoord.rowIndex == 0)
    {
        ...
        [titleButton setTitle:@"Country" forState:UIControlStateNormal];
    ...
    else
    {
        ...
        cell.textField.text = [countryArray objectAtIndex:gridCoord.rowIndex - 1];
...
{
    NSMutableArray *newResult = [NSMutableArray arrayWithArray:countryArray];
