...
@interface AllPracticesViewController ()

@end

@implementation AllPracticesViewController
...
- (void)viewDidLoad
{
    ...
    dataSource = [[AllPracticesDataSource alloc] init];
    dataSource.practiceArray = searchResult;
...
- (CGSize)contentSizeForViewInPopover
{
    ...
    return CGSizeMake(900, height);
}


#pragma mark -
#pragma mark AllPracticesDataSourceDelegate
