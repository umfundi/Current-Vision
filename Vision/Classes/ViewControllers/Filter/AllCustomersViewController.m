...
@interface AllCustomersViewController ()

@end

@implementation AllCustomersViewController
...
- (void)viewDidLoad
{
    ...
    dataSource = [[AllCustomersDataSource alloc] init];
    dataSource.customerArray = searchResult;
...
- (CGSize)contentSizeForViewInPopover
{
    ...
    return CGSizeMake(1200, height);
}


#pragma mark -
#pragma mark AllCustomerDataSourceDelegate
