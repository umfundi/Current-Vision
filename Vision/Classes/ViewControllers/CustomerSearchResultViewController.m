...
#import "CustomerSearchResultViewController.h"

#import "Customer.h"
#import "CustomerSearchResultDataSource.h"

@interface CustomerSearchResultViewController ()

@end

@implementation CustomerSearchResultViewController
...
- (void) shinobiGrid:(ShinobiGrid *)grid willCommenceEditingAutoCell:(const SGridAutoCell *)cell
{
    ...
    // Selected
    Customer *selectedCustomer = [dataSource.searchResult objectAtIndex:cell.gridCoord.rowIndex - 1];
