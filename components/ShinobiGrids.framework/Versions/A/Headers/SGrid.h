...
@private
    NSMutableDictionary *tempArrows;
    ...
    NSMutableArray               *verticalCompositeGridLines;
    NSMutableArray               *horizontalCompositeGridLinesGroupedBySection;
    NSMutableArray               *compositeBorderLines;
    ...
    void                         *_reserved;
    BOOL                          initialLoad;
    BOOL                          lastFrozenColStillNeedsValidated;
    BOOL                          lastFrozenRowStillNeedsValidated;
...
/** The minimum row height that will be used when autocolculating row heights.*/
@property (nonatomic, retain) NSNumber *minimumRowHeight;
/** The minimum col width that will be used when autocolculating col widths and resizing columns via a pinch gesture.*/
