...
/** Set this cell as being selected or as being not selected. 
 
 @warning *Important* Note that only one cell can be selected at a time. If a cell is set as being selected then any cell that is already selected will be automatically deselected.
